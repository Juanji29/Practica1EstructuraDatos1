...
int main() {
    ...
    while (estado) {
        ...
        switch (opcion) {
            case 1:
                cout << "Ingrese nombre del huesped y numero de habitacion:" << endl;
                cin >> name >> room;
                lista.insertarAlInicio(name, room);
                break;

            case 2:
                cout << "Ingrese el nombre huesped y el numero de habitacion:" << endl;
                cin >> name >> room;
            ...
            case 3: {
                ...
                cin >> ant;
                cout << "Ingrese el nombre huesped y numero de habitacion a insertar:" << endl;
                cin >> name >> room;
